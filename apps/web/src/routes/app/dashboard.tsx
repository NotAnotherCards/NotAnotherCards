            ...
            <Card className="lg:col-span-1 border border-border/60 hover:shadow-md transition-all duration-300">
              ...
              <CardContent className="space-y-4 pt-0">
                ...
                <div className="flex gap-2">
                  <Button className="flex-1 cursor-pointer gap-1.5" size="sm" onClick={handleStartReview}>
                    <Play className="size-3.5 fill-current" />
                    Start Review
                  </Button>
                  <Button variant="outline" className="flex-1 cursor-pointer gap-1.5" size="sm" onClick={handleAddWord}>
