    ...
    >
      ...
      >
        ...
        >
          {/* FRONT Side */}
          <div
            className="absolute inset-0 w-full h-full rounded-3xl border border-border/80 bg-linear-to-br from-white to-zinc-50 dark:from-zinc-800 dark:to-zinc-900 flex flex-col items-center justify-center p-8 transition-colors duration-300"
            style={{
